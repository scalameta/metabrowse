...
class Promise[V] protected () extends js.Object {
  ...
  def then[U](success: js.Function1[V, Promise[U]] = ???, error: js.Function1[js.Any, Promise[U]] = ???, progress: ProgressCallback = ???): Promise[U] = js.native
  /*
...
trait ITextModel extends js.Object {
  ...
  def findMatches(searchString: String, searchOnlyEditableRange: Boolean, isRegex: Boolean, matchCase: Boolean, wholeWord: Boolean, captureMatches: Boolean, limitResultCount: Double): js.Array[FindMatch] = js.native
  def findMatches(searchString: String, searchScope: IRange, isRegex: Boolean, matchCase: Boolean, wholeWord: Boolean, captureMatches: Boolean, limitResultCount: Double): js.Array[FindMatch] = js.native
...
trait DefinitionProvider extends js.Object {
  def provideDefinition(model: editor.IReadOnlyModel, position: Position, token: CancellationToken): Definition | Thenable[Definition]
}
